...
def test_pipeline_aggregate(drop_collections):
    ...
    customer_1_aggregate: OrdersByCustomers = list(filter(lambda x: x.id == customer_1.id, objs))[0]
    customer_2_aggregate: OrdersByCustomers = list(filter(lambda x: x.id == customer_2.id, objs))[0]
    customer_3_aggregate: OrdersByCustomers = list(filter(lambda x: x.id == customer_3.id, objs))[0]
