...
# from models import BrazilianCity, Address, Integrator, State, Vrau
...
class Lv7(DbModel):
    var_7: str
    lv_8: Lv8 = Field(by_reference=True)
    _collection: ClassVar = 'Lv7'


class Lv6(DbModel):
    var6: str
    lv_7: list[Lv7] = Field(by_reference=True)
    _collection: ClassVar = 'Lv6'


class Lv5(DbModel):
    var5: str
    lv_6: Lv6 = Field(by_reference=True)
    _collection: ClassVar = 'Lv5'


class Lv4(DbModel):
    var4: str
    lv_5: Lv5 = Field(by_reference=True)
    _collection: ClassVar = 'Lv4'


class Lv3(DbModel):
    var3: str
    lv_4: list[Lv4] = Field(by_reference=True)
    _collection: ClassVar = 'Lv3'


class Lv2(DbModel):
    var2: str
    lv_3: Lv3 = Field(by_reference=True)
    _collection: ClassVar = 'Lv2'


class Lv1(DbModel):
    var1: str
    lv_2: Lv2 | Id = Field(by_reference=True)
