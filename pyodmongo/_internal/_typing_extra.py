...
def get_function_type_hints(
    ...
    for name, value in annotations.items():
        ...
        type_hints[name] = typing._eval_type(
            value, globalns, types_namespace)  # type: ignore
            ...
            for base in reversed(obj.__mro__):
                ...
                for name, value in ann.items():
                    ...
                    value = typing._eval_type(
                        value, base_globals, base_locals)  # type: ignore
                    hints[name] = value
            return (
                hints if include_extras else {k: typing._strip_annotations(
                    t) for k, t in hints.items()}  # type: ignore
            )
