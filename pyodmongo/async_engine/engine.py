...
class AsyncDbEngine:
    ...
    # ----------DB OPERATIONS----------
    async def __save_dict(self, dict_to_save: dict, collection, indexes, query=None, raw_query=None):
    ...
    async def find_one(self, Model, query={}, populate: bool = False):
    ...
    async def find_many(self, Model, query={}, populate: bool = False, current_page: int = 1, docs_per_page: int = 1000) -> ResponsePaginate:
